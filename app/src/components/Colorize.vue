<template>
    <v-container>
        ...
        <v-spacer></v-spacer>
        <button class="christmas-button">Turn on!</button>
        <v-btn
            :disabled="inProgress"
            fixed
            bottom
...
let socket = io("http://192.168.1.69:3080", { transports: ["websocket"] });
export default {
    name: "HelloWorld",
